...
let roomPrices = {
    "Phòng đôi Paracel Resort": 3000000,
    "Phòng đơn Flamingo Hải Tiến Resort": 3300000,
    "Phòng đôi khách sạn Moonlight": 2800000,
    "Phòng đôi khách sạn Sunrise Hải Tiến": 2300000,
    "Phòng đơn Khách sạn AQUA": 1200000,
    "Phòng View biển Marissa Hotel & Spa Hai Tien": 2200000,
    "Phòng đơn Khách sạn Bình Minh": 500000,
    "Phòng đôi Khách sạn Bình Minh": 800000,
    "Phòng đơn An Hưng 2 Hotel": 500000,
    "Phòng đôi Nhà nghỉ Hải Âu": 500000,
    "Phòng đơn khách sạn Wild Horse Biển Hải Tiến": 500000,
    "Phòng đôi Hương Homestay": 600000
};
...
let restaurantPrices = {
    ...
    "Nhà hàng Cua Biển": 350000,
    "Nhà hàng Buffet Làng Chài": 300000,
    "Nhà hàng Trọng Tình": 150000,
    "Nhà hàng Lê Gia": 200000,
    "Nhà hàng Đạt Liên": 150000
};
...
function updateBookingsDisplay() {
    ...
    bookingsList.innerHTML = bookings.map((booking, index) => {
        ...
        const notesDisplay = booking.notes ? `
                <div class="booking-info booking-notes">
        ...
        return `
            <div class="booking-item">
                ...
                <div class="booking-content">
                    <div id="bookingDetails-${currentBookingType}-${index}" class="booking-details" style="display:none;">
                        <div class="booking-info">
...
function toggleBookingDetails(type, index) {
    ...
    if (!details) return;
    const bookingItem = details.closest('.booking-item');
    const button = bookingItem ? bookingItem.querySelector('.btn-detail') : null;
...
function openCancelModal(index) {
    ...
    if (currentBookingType === 'hotel') {
        const hotelPriceValue = roomPrices[booking.roomType] || 0;
        price = hotelPriceValue ? `${hotelPriceValue.toLocaleString('vi-VN')} VND/đêm` : 'Liên hệ';
    } else {
        // Use the stored booking price instead of looking it up
        const bookingPrice = booking.price || restaurantPrices[booking.restaurantName] || 0;
        price = bookingPrice ? `${bookingPrice.toLocaleString('vi-VN')} VND/người` : 'Liên hệ';
    }
